...
exports.AUTH_ERROR_USER_DISABLED = 'auth-error:user-disabled';
exports.AUTH_ERROR_USER_NOT_VERIFIED = 'auth-error:user-not-verified';
...
exports.AUTH_ERROR_PASSWORD_RESET_PROCESS_FAILED = 'auth-error:password-reset-process-failed';
exports.AUTH_ERROR_PASSWORD_RESET_TOKEN_FAILED = 'auth-error:password-reset-token-failed';
exports.AUTH_ERROR_PASSWORD_RESET_TOKEN_NOT_FOUND = 'auth-error:password-reset-token-not-found';
